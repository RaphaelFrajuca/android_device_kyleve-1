...
ifeq "$(wildcard $(KERNEL_SRC) )" ""
 ...
 ifneq ($(TARGET_KERNEL_CUSTOM_TOOLCHAIN),)
            ARM_CROSS_COMPILE:=CROSS_COMPILE="$(ccache) $(ARM_EABI_TOOLCHAIN)/$(TARGET_KERNEL_CUSTOM_TOOLCHAIN)/bin/arm-eabi-"
        endif
...
ifeq ($(TARGET_ARCH),arm)
    ...
    ifeq ($(HOST_OS),darwin)
      ARM_CROSS_COMPILE:=CROSS_COMPILE="$(ccache) $(ANDROID_BUILD_TOP)/prebuilt/darwin-x86/toolchain/arm-eabi-4.4.6/bin/arm-eabi-"
    else
      ARM_CROSS_COMPILE:=CROSS_COMPILE="$(ccache) $(ANDROID_BUILD_TOP)/prebuilt/linux-x86/toolchain/arm-eabi-4.6/bin/arm-eabi-"
    endif
    ccache = 
endif
